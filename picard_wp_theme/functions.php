...
function custom_post_type() {
    ...
    $labels = array(
        'name' => _x('Diario', 'Post Type General Name', 'text_domain'),
        'singular_name' => _x('Diario', 'Post Type Singular Name', 'text_domain'),
        'menu_name' => __('Diario', 'text_domain'),
        'name_admin_bar' => __('Diario', 'text_domain'),
...
function custom_post_type2() {
    ...
    $labels = array(
        'name' => _x('Relatorio', 'Post Type General Name', 'text_domain'),
        'singular_name' => _x('relatorio', 'Post Type Singular Name', 'text_domain'),
        'menu_name' => __('Relatorio', 'text_domain'),
        'name_admin_bar' => __('Relatorio', 'text_domain'),
        'archives' => __('Item Archives', 'text_domain'),
        'parent_item_colon' => __('Parent Item:', 'text_domain'),
        'all_items' => __('All Items', 'text_domain'),
        'add_new_item' => __('Add New Item', 'text_domain'),
